...
var Select = React.memo(function (_a) {
     ...
     * The Select options
     */
    var selectOptions = options.map(function (option, index) { return (React.createElement(react_core_1.SelectOption, { key: index, value: option, isSelected: true })); });
    /**
     * Toggle the Select
     */
    ...
    return (React.createElement(React.Fragment, null, isReadOnly ? (React.createElement(react_core_1.Tooltip, { content: selected, distance: 0, exitDelay: 0, trigger: overflown ? 'mouseenter focus' : 'manual' },
        React.createElement("input", { onMouseOver: checkForOverflow, className: "editor-input truncate", style: { cursor: 'default', textAlign: type === 'string' ? 'left' : 'center' }, type: "text", value: selected, id: id, "aria-label": selected, readOnly: true }))) : (React.createElement(react_core_1.Select, { toggleId: id, variant: react_core_1.SelectVariant.single, "aria-label": "Select Input", onToggle: onToggle, onSelect: onSelect, selections: selected, isExpanded: isExpanded, ariaLabelledBy: "typeahead-select-id", onKeyDown: onKeyDown }, selectOptions))));

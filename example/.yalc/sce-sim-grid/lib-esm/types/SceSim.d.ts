...
export declare enum ImportsTYPENAME {
...
export declare enum FactMappingValueTYPENAME {
...
export declare enum RawValueTYPENAME {
    ScesimRawValueType = "scesim.RawValueType"
}
export declare enum Clazz {
    String = "string"
}
...
export declare enum ExpressionElementTYPENAME {

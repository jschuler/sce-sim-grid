...
var _jsonix_factory = function (_jsonix_xmldom, _jsonix_xmlhttprequest, _jsonix_fs) {
    ...
    Jsonix.Model.ClassInfo = Jsonix
        ...
        unmarshal: function (context, input) {
            ...
            if (Jsonix.Util.Type.exists(this.structure.anyAttribute)) {
                ...
                this
                    .unmarshalProperty(context, input, propertyInfo, result);
            }
            // Read elements
        ...
        aa: function (mapping) {
            ...
            return this
                .addProperty(new this.mappingStyle.anyAttributePropertyInfo(mapping, {
        ...
        ae: function (mapping) {
            this.addDefaultNamespaces(mapping);
            return this
                .addProperty(new this.mappingStyle.anyElementPropertyInfo(mapping, {
                mappingStyle: this.mappingStyle
            }));
        },
        a: function (mapping) {
        ...
        em: function (mapping) {
            this.addDefaultNamespaces(mapping);
            return this
                .addProperty(new this.mappingStyle.elementMapPropertyInfo(mapping, {
                mappingStyle: this.mappingStyle
            }));
        },
        e: function (mapping) {
        ...
        er: function (mapping) {
            this.addDefaultNamespaces(mapping);
            return this
                .addProperty(new this.mappingStyle.elementRefPropertyInfo(mapping, {
                mappingStyle: this.mappingStyle
            }));
        },
        ers: function (mapping) {
            this.addDefaultNamespaces(mapping);
            return this
                .addProperty(new this.mappingStyle.elementRefsPropertyInfo(mapping, {
                mappingStyle: this.mappingStyle
            }));
        },
        v: function (mapping) {
    ...
    Jsonix.Schema.XSD.List = Jsonix
        .Class(Jsonix.Schema.XSD.AnySimpleType, {
        name: null,
        typeName: null,
        typeInfo: null,
        separator: ' ',
        ...
        parse: function (text, context, input, scope) {
            ...
            var items = Jsonix.Util.StringUtils
                .splitBySeparatorChars(text, this.trimmedSeparator);
            var result = [];
    ...
    Jsonix.Schema.XSD.Duration = Jsonix.Class(Jsonix.Schema.XSD.AnySimpleType, {
        ...
        isInstance: function (value, context, scope) {
            return Jsonix.Util.Type.isObject(value) && ((Jsonix.Util.Type.exists(value.sign) ? (value.sign === -1 || value.sign === 1) : true)(Jsonix.Util.NumberUtils.isInteger(value.years) && value.years >= 0) ||
...
//# sourceMappingURL=jsonix.js.map
 ...
 */
export var getJsonFromSceSim = function (scesim) {
 ...
 */
export var setSceSimFromJson = function (json) {
 ...
 */
export var getJsonFromDmn = function (dmn) {
 ...
 */
export var setDmnFromJson = function (json) {
